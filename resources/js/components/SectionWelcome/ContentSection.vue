    ...
    <div class="container">
      <section class="features-overview" id="features-section" >
        <div class="content-header">
          ...
          <h6 class="section-subtitle text-muted">
            At TabsContent, we have a team of writers with great experience and the required skill set to help our customers develop well researched and helpful content for their websites. We have adequate expertise to help our customers with the following Services:
        ...
        <div class="d-md-flex justify-content-between">
          <div class="grid-margin d-flex justify-content-start">
            <div class="features-width">
              ...
              <h5 class="py-3">Web Page<br>Content Writing
</h5>
              <p class="text-muted">
                We understand that your web page is what determines if you get to convert your audience to customers. With the understanding of your products and services, our team of writers will develop informative content to help you with conversions. 
          ...
          <div class="grid-margin d-flex justify-content-center">
            <div class="features-width">
              ...
              <h5 class="py-3">Blog<br>Writing Services</h5>
              <p class="text-muted">
                 Other than keeping your audience entertained, having regular blog posts will help you get a better ranking with Google search engines. Our Writers are trained to come up with search engine friendly blog posts for our customers.
                </p>
              <a href="#"><p class="readmore-link">Readmore</p></a>
            </div>
          </div>
          <div class="grid-margin d-flex justify-content-end">
            <div class="features-width">
              ...
              <h5 class="py-3">SEO Content<br>Writing Services</h5>
              <p class="text-muted">
                  Are you worried that your online content does not reach out to as many people as you would wish? SEO-friendly content is what you need. We have SEO writing experts who only focus on creating content that meets all Google’s guidelines for better ranking.
          ...
          <div class="col-12 col-lg-7 grid-margin grid-margin-lg-0" data-aos="fade-right">
            ...
            <div class="col-lg-7 col-xl-6 p-0">
              ...
              <p class="font-weight-medium text-muted">
               Technical writing is not everyone’s cup of tea. It is complex in nature, and in most cases, only professionals can handle it. When dealing with technical topics, writing experts strive to present complex information in the most simple and relatable format. 
          ...
          <div class="col-12 col-lg-5 flex-item grid-margin" data-aos="fade-left">
            ...
            <div class="col-lg-9 col-xl-8 p-0">
              ...
              <p class="pb-2 font-weight-medium text-muted">
                   Are you planning to expand your business’s presence or release a new product? A press release is the best way to keep your audience aware of the development. Publishing press releases on the internet will help to increase traffic on your website as well as get backlinks from newspapers and probably other sites. 
                </p>
            </div>
      ...
      <!-- <section class="contact-us" id="contact-section">
        <div class="contact-us-bgimage grid-margin" >
          <div class="pb-4">
            <h4 class="px-3 px-md-0 m-0">Order Custom Content Now!</h4>
      ...
      <section class="contact-details" id="contact-details-section">
        <div class="row text-center text-md-left">
          <div class="col-12 col-md-6 col-lg-6 grid-margin">
            ...
            <div class="pt-2">
              <p class="text-muted m-0">admin@tabscontent.com</p>
              <p class="text-muted m-0">906-179-8309</p>
            </div>         
          </div>
          <div class="col-12 col-md-6 col-lg-6 grid-margin">
            <h5 class="pb-2">Get in Touch</h5>
            <p class="text-muted">Subscribe to our Newsletter to get all updates.</p>
            <form>
      ...
      <footer class="border-top">
        <p class="text-center text-muted pt-4">Copyright © 2020<a href="https://www.bootstrapdash.com/" class="px-1">tabscontent.</a>All rights reserved.</p>
      </footer>
